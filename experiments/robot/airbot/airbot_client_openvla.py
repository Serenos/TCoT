...
if __name__ == "__main__":
    ...
    parser.add_argument('-uk', "--unnorm_key", action='store', type=str, help='unnorm key', default="airbot_mix", required=False)
    ...
    parser.add_argument('-can', "--can_buses", action='store', type=str, help='can_bus', default="can1", required=False)
    parser.add_argument('-em', "--eef_mode", action='store', type=str, help='eef_mode', default="gripper")
    parser.add_argument("--time_steps", action='store', type=int, help='max_timesteps', default=50)
    ...
    for index, can in enumerate(can_list):
        ...
        #airbot_player = airbot.create_agent("down", can, eef_mode) # urdf_path
    ...
    while True:
        ...
        # airbot_player.set_target_end(1)
        time.sleep(1)
        try:
