...
class OpenVLAServer:
    def __init__(self, openvla_path: Union[str, Path], attn_implementation: Optional[str] = "flash_attention_2") -> Path:
        ...
        using_lora = True
        if using_lora:
            adapter_dir = "/home/cvailab/codebase/embodied-CoT/openvla/exp_model/lora_model_airbot/openvla-7b+airbot_feed+openvla+airbot_feed_with_spoon+cofintune0.0/step_3000"
