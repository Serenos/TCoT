...
#print(f"Loading owlvit to device {device}...")
checkpoint = "google/owlvit-base-patch16"
detector = pipeline(model=checkpoint, task="zero-shot-object-detection")#.to(device)

#print(f"Loading sammodel to device {device}...")
