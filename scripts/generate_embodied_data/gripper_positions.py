...
ds = b.as_dataset(split=f'train[0%:100%]')

results_path = '/home/lixiang/codebase/embodied-CoT/scripts/generate_embodied_data/bounding_boxes/gripper_position'
results_json_path = os.path.join(results_path, "gripper_position_libero.json")
...
for i, episode in enumerate(tqdm(ds)):
    ...
    gripper_traj_list = get_corrected_positions(episode_id, episode)

    episode_json = {
        "episode_id": int(episode_id),
        "file_path": file_path,
        "gripper_trajectory": gripper_traj_list.tolist(),
    }
