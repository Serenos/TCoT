...
from prismatic.vla.datasets.rlds.utils.data_utils import (
    ...
    relabel_airbot_actions,
)

def airbot_mix_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    step = 1
    skip = 1 #6
    stop = 1 #10
    trajectory["observation"]["image"] = trajectory["observation"]["image"][skip:-stop:step]
    trajectory["observation"]["state"] = trajectory["observation"]["state"][skip:-stop:step]
    trajectory["action"] = trajectory["action"][skip:-stop:step]
    trajectory["language_instruction"] = trajectory["language_instruction"][skip:-stop:step]
    trajectory = relabel_airbot_actions(trajectory)
...
OXE_STANDARDIZATION_TRANSFORMS = {
    "airbot_mix": airbot_mix_dataset_transform,
    ...
    "libero_spatial_failure_500try": libero_dataset_transform,
    "libero_object_fail500try": libero_dataset_transform,
    "libero_goal_fail500try": libero_dataset_transform,
    "libero_10_fail200try": libero_dataset_transform,
    "libero_10_fail200try_end60": libero_dataset_transform,
    ### Real World Airbot dataset
    "airbot_mix_stack_cube": airbot_mix_dataset_transform,
    "airbot_mix_stack_bowl": airbot_mix_dataset_transform,
    "airbot_mix_pick_cube": airbot_mix_dataset_transform,
    "airbot_mix_pick_cup": airbot_mix_dataset_transform,
    "airbot_mix_grasp_spoon": airbot_mix_dataset_transform,
    "airbot_mix_use_spoon": airbot_mix_dataset_transform,
}
