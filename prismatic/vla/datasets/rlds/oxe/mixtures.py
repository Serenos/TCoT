...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "libero_spatial_retry": [
        ("libero_spatial", 1.0),
        ("libero_spatial_failure_500try", 0.1),
    ],
    "libero_object_retry": [
        ("libero_object", 1.0),
        ("libero_object_fail500try", 0.1),
    ],
    "libero_goal_retry": [
        ("libero_goal", 1.0),
        ("libero_goal_fail500try", 0.1),
    ],
    "libero_10_retry": [
        ("liber_o10", 1.0),
        ("libero_10_fail200try", 0.1),
    ], 
    "libero_10_end60_retry": [
        ("liber_o10", 1.0),
        ("libero_10_fail200try_end60", 0.1),
    ], 
    # === Real World Airbot Finetuning Datasets ===
    "airbot_mix":[
        ("airbot_mix_pick_cup", 1.0),
        ("airbot_mix_pick_cube", 0.2),
        ("airbot_mix_stack_bowl", 1.0),
        ("airbot_mix_stack_cube", 1.0),
    ],
    "airbot_feed":[
        ("airbot_mix_grasp_spoon", 1.0),
        ("airbot_mix_use_spoon", 1.0),
    ]
}
# fmt: on
